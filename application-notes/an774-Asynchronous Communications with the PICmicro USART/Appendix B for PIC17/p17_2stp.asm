...
;=============================================================================
;	PIC17XXX USART example code using two stop bits with receive polling
...
ReceiveSerial:	movlb	1		;SFR bank 1
		...
		btfss	RCSTA1,RX9D	;if first stop bit error occurred
		goto	ErrSerialFrame	;then go handle error
...
SetupSerial:	movlb	0		;SFR bank 0
		...
		movwf	SPBRG1
		movlw	0x61		;enable nine bit transmission
		movwf	TXSTA1
