...
;=============================================================================
;	PIC16XXX USART example code with receive polling and transmit waiting.
...
;	routine then calls a subroutine that waits until the transmitter is
;	ready and transmits the data.
;=============================================================================
